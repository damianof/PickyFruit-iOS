...
-(id)init
{
	...
	//if ((self = [super init]))
	{
        ...
        CCSprite *spritePause = [[CCSprite alloc] initWithSpriteFrameName:@"UILayerPause"];
        CCSprite *spritePauseSelected = [[CCSprite alloc] initWithSpriteFrameName:@"UILayerPause"];
        ...
        // ------- labels ----------------
        // label Time Elapsed
        unitsPosition = UnitsPointMake(screenFirstQuarterX, 3.4f);
        _labelTimeElapsed = [[CCLabelBMFont alloc] initWithString:@"Time: 0.0" fntFile:kBmpFontUI16];
        ...
        // label Lifes
        unitsPosition = UnitsPointMake(screenFirstQuarterX, 1.3f);
        _labelLifesRemaining = [[CCLabelBMFont alloc] initWithString:@"10" fntFile:kBmpFontUI16];
        _labelLifesRemaining.position = [DevicePositionHelper pointFromUnitsPoint:unitsPosition];
        [self addChild:_labelLifesRemaining z:kInt0 tag:UILayerTagLabelLifes];
        ...
        // add Replay button
        CCSprite *spriteReplay = [[CCSprite alloc] initWithSpriteFrameName:@"UILayerReplay"];
        CCSprite *spriteReplaySelected = [[CCSprite alloc] initWithSpriteFrameName:@"UILayerReplay"];
...
{    
    ...
    [_labelLifesRemaining release];
    _labelLifesRemaining = nil;
               ...
               totFruitsDestroyed:(int)totFruitsDestroyed
{
    if([GameManager sharedInstance].running)
    {
        NSString *str = [[NSString alloc] initWithFormat:kStringFormatInt, (totFruitsDestroyed-10)];
		[_labelLifesRemaining setString:str];
        [str release];
        str = nil;
